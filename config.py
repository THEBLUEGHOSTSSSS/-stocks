...
STATIC_TICKER_METADATA = {
    ...
    "TQQQ": {"name": "3倍做多纳指100", "category": "杠杆ETF/纳指科技"},
    "SQQQ": {"name": "3倍做空纳指100", "category": "反向杠杆ETF/纳指科技"},
    "DIA": {"name": "道琼斯工业平均 ETF", "category": "蓝筹指数ETF"},
    "IWM": {"name": "罗素2000 ETF", "category": "中小盘指数ETF"},
    "SOXL": {"name": "3倍做多半导体", "category": "杠杆ETF/半导体"},
    "SOXX": {"name": "iShares 半导体 ETF", "category": "半导体产业ETF"},
    "SMH": {"name": "VanEck 半导体 ETF", "category": "半导体产业ETF"},
    "NVDL": {"name": "2倍做多英伟达", "category": "杠杆ETF/NVDA"},
    "FNGU": {"name": "3倍做多高beta科技", "category": "杠杆ETF/高beta科技"},
    "NVDA": {"name": "英伟达", "category": "半导体/AI算力"},
    "AAOI": {"name": "Applied Optoelectronics", "category": "光模块/CPO"},
    "AAOX": {"name": "2倍做多光模块", "category": "杠杆ETF/光模块"},
    "SIVEF": {"name": "Sivers Semiconductors OTC", "category": "海外映射/OTC半导体"},
